...
[详解](obsidian://open?vault=hello_agent_learings&file=A2A%E8%AF%A6%E8%A7%A3)
...
注意 MCP服务端需要编写  服务端功能就是注册工具 客户端就是使用 搞清楚这个关系就没问题了
...
关于MCP 后续会进行一个详细的学习 或许我将用一个实体项目来持续学习
